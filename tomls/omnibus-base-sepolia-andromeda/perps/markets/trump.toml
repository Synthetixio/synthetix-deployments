...
trump_perps_market_skew_scale = "<%= parseEther(String(750_000)) %>"
...
trump_perps_max_market_size = "<%= parseEther(String(105_000)) %>"
trump_perps_max_market_value = "<%= parseEther(String(3_000_000)) %>"
trump_perps_initial_margin_ratio = "<%= parseEther('14.837') %>"
