...
contract DebtBurningReset_Test is CommonTest {
    ...
    function test_DebtBurningReset() public {
        ...
        _validatePosition("ALI +30 days, after deposit", ALI, 10 ether, ts + 30 days, 30 days, 120 ether);
        _validatePosition("BOB +30 days, no action", BOB, 0, 0, 0, 120 ether);
        ...
        vm.warp(ts + 90 days);
        _validatePosition("ALI +90 days", ALI, 10 ether, ts + 30 days, 30 days, 120 ether);
        _validatePosition("BOB +90 days", BOB, 0, 0, 0, 120 ether);
        _validatePosition("DAO +90 days", DAO, 10 ether, ts + 30 days, 30 days, 120 ether);
        _validatePosition("GAS +90 days", GAS, 12 ether, ts + 30 days, 30 days, 120 ether);
        ...
        _validatePosition("WAT? Burning? DAO +90 days, after 0.2 ratio", DAO, 10 ether, ts + 30 days, 30 days, 100 ether);
        ...
        _validatePosition("ALI +150 days, after 20% deposit, started burning", ALI, 24 ether, ts + 150 days, 150 days, 120 ether);
        _validatePosition("BOB +150 days, reset", BOB, 0 ether, ts + 90 days, 90 days, 120 ether);
        _validatePosition("DAO +150 days, after 20% deposit, started burning", DAO, 24 ether, ts + 150 days, 90 days, 100 ether);
        ...
        _validatePosition("BOB +210 days, deposits 20%, started burning", BOB, 24 ether, ts + 210 days, 210 days, 120 ether);
