...
describe(require('path').basename(__filename, '.e2e.js'), function () {
  ...
  it('should have max open interest 10_000 ETH', async () => {
  ...
  it('should have 10_000 ETH Max Market Size', async () => {
    const maxMarketSize = await PerpsMarketProxy.getMaxMarketSize(marketId);

    assert.equal(ethers.utils.formatEther(maxMarketSize), 10_000);
  });
